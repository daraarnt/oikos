...
export const PLACE_CATEGORIES = Object.freeze({
  ...
  // These three are used by Oikos' CSC siting screen as a first-pass check under
  // KCanG § 12(1) no. 6. They deliberately stay available to the generic POI
  // service too: one cache and one careful Overpass client is safer than a second
  // set of location lookups for the same map data.
  playground: { tags: [['leisure', 'playground']] },
  childcare: { tags: [['amenity', 'childcare']] },
  youthCentre: { tags: [['amenity', 'youth_centre']] },
  gym: {
    tags: [
